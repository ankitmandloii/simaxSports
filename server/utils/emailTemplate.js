  ...
  <table width="600" align="center" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
    <tr>
      <td style="padding: 20px 0;">
        <img src="https://simaxdesigns.imgix.net/uploads/1752672777946_design.png" alt="SimaxSports Logo" style="display: block; margin: 0 auto; width: 150px;">
      </td>
    </tr>
    <tr>
      <td style="background-color: #ffffff; padding: 40px; border-radius: 10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);">
        ...
        <p style="font-size: 16px; color: #333; text-align: center; font-weight: bold; margin-top: 30px;">Design Name: Simax Design</p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 40px;">
          <tr>
            <td align="center" style="padding: 10px;">
              <a href="#" style="display: inline-block; padding: 12px 25px; background-color: #005bff; color: #ffffff; text-decoration: none; border-radius: 5px; font-size: 16px; font-weight: bold;">Edit Design</a>
            </td>
            <td align="center" style="padding: 10px;">
              <a href="#" style="display: inline-block; padding: 12px 25px; background-color: #005bff; color: #ffffff; text-decoration: none; border-radius: 5px; font-size: 16px; font-weight: bold;">Add To Cart</a>
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr>
      <td style="background-color: #e6e6e6; padding: 20px; text-align: center; margin-top: 20px; border-radius: 10px;">
        ...
        <p style="font-size: 16px; color: #555;">Call <a href="tel:1234567890" style="color: #007bff; text-decoration: none;">(800) 970-0227</a> or email <a href="mailto:service@simaxsports.com" style="color: #007bff; text-decoration: none;">service@simaxsports.com</a> to chat with an expert now & create your masterpiece!</p>
      </td>
    </tr>
    <tr>
      <td style="background-color: #FFFFFFFF; padding: 20px; text-align: center;">
        <img src="https://simaxdesigns.imgix.net/uploads/1752672777946_design.png" alt="SimaxSports Footer Logo" style="display: block; margin: 0 auto; width: 120px; margin-bottom: 15px;">
