...
//                 const fileUrl = uploadResponse.data.files[0]?.url;
//                 if (!fileUrl) throw new Error("File object missing URL");
...
//                 // ✅ close popup after new image applied
//             } catch (err) {
//                 console.error("Error uploading image:", err.message);
//                 toast.error(`Error uploading image: ${err.message}`);
//             }
//         } else if (type === "your") {
//             // ✅ just keep original and close popup
//             onClose();
//         }
//     };
...
//                                         )}
//                                         {selectedImage === "your" && (
//                                             <button className={styles.useImageButton} onClick={() => handleImageSelect("your")}>
//                                                 Original Image
//                                             </button>
//                                         )}
//                                     </div>
...
//                                         />
//                                         {selectedImage === "new" && (
//                                             <button className={styles.useImageButton} onClick={() => handleImageSelect("new")}>
//                                                 New Image
//                                             </button>
//                                         )}
//                                     </div>
