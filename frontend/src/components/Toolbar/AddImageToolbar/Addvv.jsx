...
//   const applyColorBlend = (originalColor, newColor) => {
//     console.log("----------colornew", originalColor, "---", newColor)
//     if (!img?.src) return;

//     const base = img.src.split("?")[0];
//     const hexNew = newColor.replace("#", "");
//     const transform = `?blend=${hexNew}&blend-mode=color&blend-alpha=1`;
...
//                           defaultColor={selectedColorToReplace}
//                           onApply={(newColor) => {
//                             applyColorBlend(selectedColorToReplace, newColor);
