...
import { setActiveSide } from '../redux/FrontendDesign/TextFrontendDesignSlice';
...
const toggleZoom = () => {
  ...
  return (
    ...
    <div className="ProductContainerMainDiv">
      ...
      <MainDesignTool  id="mirrorCanvasFront" key="front"  mirrorCanvasRef={mirrorCanvasRef}  initialDesign={frontDesignRef.current} backgroundImage={frontBgImage} zoomLevel={zoomLevel}/>
      </div>
      <div style={{ display: !ShowFrontImage ? 'block' : 'none' }}>
        <MainDesignTool  id="mirrorCanvasBack"  key="back" mirrorCanvasRef={mirrorCanvasRefForBackImage} initialDesign={backDesignRef.current} backgroundImage={backBgImage} zoomLevel={zoomLevel}/>
       </div>
