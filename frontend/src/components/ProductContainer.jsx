      ...
      <div className='flex'>
        ...
        <div className='Prouduct-mirror-left-container'>
          ...
          <div className="design-side-buttons" onClick={ShowBack}>
            {/* <button onClick={() => setIsDesignBack("front")}>Design Front</button> */}
            ...
            <button onClick={() => seIsDesignRightSleeve(true)}>Design Right Sleeve</button>
            <button onClick={() => seIsDesignRightSleeve(true)}>Design Left Sleeve</button>
          </div>
        </div>
