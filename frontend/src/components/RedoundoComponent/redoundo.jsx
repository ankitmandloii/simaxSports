...
function RedoundoComponent() {
  ...
  return (
    <ul className='redoundo-container ProductContainerListButtton'>
      ...
      <li><button className='ProductContainerButton' onClick={() => setStartOverPopup(!startOverPopup)} disabled={!canStartOver}><span><StartOverIcon /></span>START OVER</button></li>
