...
function createWarningForSweatShirt({canvasWidth, canvasHeight, canvas,warningColor,activeSide,getProductSleeveType,activeProductTitle,fabric}) {
...
export default createWarningForSweatShirt;